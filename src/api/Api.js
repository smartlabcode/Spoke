...
export const scaledThumbnailUrlFor = (url, width, height) => {
  if (configs.RETICULUM_SERVER.includes("smartexpo.bitallium.com") && url.includes("smartexpo.bitallium.com")) {
    return url;
  }
...
export default class Project extends EventEmitter {
  ...
  getSceneUrl(sceneId) {
    if (configs.HUBS_SERVER === "localhost:8080" || configs.HUBS_SERVER === "smartexpo.bitallium.com:8080") {
